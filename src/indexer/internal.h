 ...
 */
size_t artwork_atlas_builder_sweep_no_art(artwork_atlas_builder_t *builder, GArray *promoted_ids);
 ...
 */
void artwork_atlas_builder_set_fanart_covers_dir(artwork_atlas_builder_t *builder, const char *dir);
 ...
 */
int32_t artist_atlas_reader_lookup(const artist_atlas_reader_t *reader, const uint8_t uuid[16]);
 ...
 */
const uint8_t *artist_atlas_reader_get_pixels(const artist_atlas_reader_t *reader, int32_t index);
...
atlas_crc32_update(uint32_t crc, const uint8_t *data, size_t len)
{
...
static inline uint32_t
atlas_crc32(const uint8_t *data, size_t len)
{
